...
- **Адаптивное разворачивание окна и надежный Flexbox:**
  ...
  - Плавное динамическое расширение ширины окна (до `820px`) и высоты блока изменений для удобного чтения объемных списков нововведений.
  - Исключение утечек памяти: гарантированная очистка таймеров закрытия при размонтировании и поддержка выхода по `Esc` даже при ошибках загрузки.
