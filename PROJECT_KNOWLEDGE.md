...
│   │   │   ├── GeneralSettingsTab.tsx    # Основные настройки (3 эргономичных блока: воспроизведение и окна, аудиодорожки и субтитры, скриншоты)
...
│   │   ├── modals.css                    # Модальные окна (Настройки с сетками 3x2/2x2, MediaInfo, Chapters)
