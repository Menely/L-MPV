...
- **Настройка папки скриншотов, Акцентных Пастельных Цветов и Кастомных Биндов:**
  - В модальном окне `SettingsModal`:
    ...
    - Выбор монохромных и чистых акцентных пастельных цветов (включая **#e8a236** Amber и **#FFA9DE** Pink). Градиентные темы полностью удалены.
    - **Расширенная гибридная система привязки клавиш и кнопок мыши**:
      - Поддержка нескольких привязок (массив биндов) для каждого из 28 действий плеера.
      - Возможность биндить комбинации клавиш клавиатуры, а также одиночные и двойные клики ЛКМ и ПКМ (`MouseLeft`, `MouseRight`, `MouseLeftDouble`, `MouseRightDouble`).
