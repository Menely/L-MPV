...
│   │   └── commands.rs                   # 75 IPC #[tauri::command] функций, извлечение дорожек FFmpeg, персистентность AppSettings
...
- Регистрирует все **83 IPC-команды** в `tauri::Builder`.
...
В бэкенде зарегистрировано **83 IPC-команды**:
