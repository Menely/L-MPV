...
│   │   │   ├── GeneralSettingsTab.tsx    # Основные настройки (4 эргономичных блока: воспроизведение и окна, дорожки, скриншоты, контекстное меню ПКМ)
│   │   │   ├── ContextMenuSettingsTab.tsx # Интерактивный Drag-and-Drop редактор контекстного меню ПКМ (@dnd-kit)
│   │   │   ├── UpscalingSettingsTab.tsx  # Управление 4K AI апскейлингом (DirectML / TensorRT, библиотека ONNX моделей)
...
│   │   │   ├── AudioVisualizerSettingsTab.tsx # Настройки аудио-визуалайзера (режимы, стили, баллистика)
