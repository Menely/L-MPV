...
<p align="center">
  <img src="https://img.shields.io/badge/Version-1.6.3-blueviolet?style=for-the-badge" alt="Version 1.6.3">
...
- **3 стиля визуализации:** `Waveform` (многослойная волна с динамическими спектральными гармониками), `Spectrum` (32-полосный эквалайзер) и `Bars` (ритм-капсулы Apple Music / Spotify style).
...
<details>
<summary><b>🎧 Студийный Аудиофильский Звук (Audiophile Profile)</b></summary>
...
<details>
<summary><b>🎨 Премиальный Glassmorphic UX/UI</b></summary>
...
- **Мягкое контурное свечение (Vector Drop-Shadow):** филигранное рассеивание света строго по контуру векторных SVG-иконок с плавным градиентным угасанием без грубых круговых ареолов и сбалансированной интенсивностью.
...
- **Умная адаптивность для вертикальных видео и узких окон:** динамическая подстройка панели управления на базе CSS Container Queries; текстовые плашки и второстепенные кнопки плавно скрываются при нехватке места, исключая переполнение и обрезку кнопок на вертикальных видео (Shorts/Reels/TikTok).
- **Кастомное ПКМ-меню:** доступ ко всем настройкам видео, аудио, масштабирования, поворота и подсветки полос по правому клику с адаптивной прокруткой.
...
| **Скорость** | Выбор скорости (0.25x – 2.0x) | Кнопка `1.0x` на панели / Настраивается в Настройках |
