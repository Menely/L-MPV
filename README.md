...
- **Оптимизированная строка таймлайна (`.timeline-row`):** метка времени воспроизведения перенесена непосредственно на строку таймлайна справа от полосы прогресса, разгружая кнопки тулбара и повышая наглядность.
