...
<p align="center">
  <img src="https://img.shields.io/badge/Version-1.6.8-blueviolet?style=for-the-badge" alt="Version 1.6.8">
...
<details>
<summary><b>🎨 Премиальный Glassmorphic UX/UI & Цветовые Темы</b></summary>

- **7 Кинематографичных тем оформления плеера:** *Тёмный графит*, *Глубокий OLED*, *Сапфировая полночь*, *Тёмный изумруд*, *Аметист*, *Вулканический мокко*, *Холодный Норд* с автоматической динамической гармонизацией фона, текста, поверхностей и акцентов.
...
- **Умная адаптивность для вертикальных видео и узких окон:** динамическая подстройка панели управления на базе CSS Container Queries; текстовые плашки и второстепенные кнопки плавно скрываются при нехватке места.
