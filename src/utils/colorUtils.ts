...
export const PLAYER_THEMES: Record<PlayerThemeId, PlayerThemeConfig> = {
  ...
  sapphire: {
    ...
    tokens: {
      ...
      bgGlassRgb: "11, 19, 36",
      bgPillRgb: "7, 12, 23",
      textPrimary: "rgba(240, 246, 255, 0.96)",
      textSecondary: "rgba(205, 222, 250, 0.82)",
      textMuted: "rgba(165, 190, 225, 0.55)",
  ...
  emerald: {
    ...
    tokens: {
      ...
      bgGlassRgb: "10, 26, 19",
      bgPillRgb: "6, 17, 12",
      textPrimary: "rgba(240, 255, 248, 0.96)",
      textSecondary: "rgba(200, 240, 222, 0.82)",
      textMuted: "rgba(155, 210, 185, 0.55)",
  ...
  amethyst: {
    ...
    tokens: {
      ...
      bgGlassRgb: "30, 17, 48",
      bgPillRgb: "19, 10, 30",
      textPrimary: "rgba(250, 244, 255, 0.96)",
      textSecondary: "rgba(230, 212, 250, 0.82)",
      textMuted: "rgba(195, 172, 225, 0.55)",
  ...
  nord: {
    ...
    tokens: {
      ...
      bgGlassRgb: "18, 25, 36",
      bgPillRgb: "11, 16, 23",
      textPrimary: "rgba(245, 249, 255, 0.96)",
      textSecondary: "rgba(208, 224, 242, 0.82)",
      textMuted: "rgba(162, 185, 212, 0.55)",
  ...
  discord: {
    ...
    tokens: {
      ...
      textSecondary: "rgba(195, 200, 208, 0.82)",
      textMuted: "rgba(155, 162, 172, 0.55)",
      border: "rgba(255, 255, 255, 0.09)",
      borderHover: "rgba(255, 255, 255, 0.18)",
    },
  ...
  pine: {
    ...
    tokens: {
      ...
      textSecondary: "rgba(198, 235, 216, 0.82)",
      textMuted: "rgba(152, 200, 178, 0.55)",
  ...
  mint: {
    ...
    tokens: {
      ...
      textSecondary: "rgba(190, 242, 236, 0.82)",
      textMuted: "rgba(145, 208, 202, 0.55)",
  ...
  ruby: {
    ...
    tokens: {
      ...
      textSecondary: "rgba(250, 214, 222, 0.82)",
      textMuted: "rgba(225, 176, 186, 0.55)",
  ...
  indigo: {
    ...
    tokens: {
      ...
      textSecondary: "rgba(218, 218, 252, 0.82)",
      textMuted: "rgba(178, 178, 228, 0.55)",
...
export function applyPlayerTheme(themeId: string): void {
  ...
  root.style.setProperty("--bg-modal-solid", tokens.bgSurface || "#11141c");
...
const GLOW_PROFILES: Record<Exclude<GlowIntensity, "off">, GlowProfile> = {
  soft: {
    ...
    activeIcon: (rgb) => `drop-shadow(0 0 3px rgba(${rgb}, 0.55))`,
    playIcon: (rgb) => `drop-shadow(0 0 4px rgba(${rgb}, 0.65))`,
    hoverIcon: (rgb) => `drop-shadow(0 0 4px rgba(${rgb}, 0.55))`,
  },
  medium: {
    alpha: [0.48, 0.42],
    ...
    activeIcon: (rgb) => `drop-shadow(0 0 3px rgba(${rgb}, 0.65)) drop-shadow(0 0 8px rgba(${rgb}, 0.25))`,
    playIcon: (rgb) => `drop-shadow(0 0 4px rgba(${rgb}, 0.75)) drop-shadow(0 0 10px rgba(${rgb}, 0.30))`,
    hoverIcon: (rgb) => `drop-shadow(0 0 4px rgba(${rgb}, 0.65))`,
  },
  intense: {
    alpha: [0.75, 0.68],
    ...
    activeIcon: (rgb) => `drop-shadow(0 0 4px rgba(${rgb}, 0.80)) drop-shadow(0 0 12px rgba(${rgb}, 0.35))`,
    playIcon: (rgb) => `drop-shadow(0 0 5px rgba(${rgb}, 0.85)) drop-shadow(0 0 14px rgba(${rgb}, 0.40))`,
    hoverIcon: (rgb) => `drop-shadow(0 0 5px rgba(${rgb}, 0.80)) drop-shadow(0 0 10px rgba(${rgb}, 0.30))`,
  },
};
